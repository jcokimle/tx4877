...
class Ui_MainWindow(object):
    def setupUi(self, Main):
        ...
        Main.setMinimumSize(QtCore.QSize(570, 500))
        ...
        self.actionQuitter = QtGui.QAction(Main)
        self.actionQuitter.setObjectName(_fromUtf8("actionQuitter"))
        self.actionA_propos = QtGui.QAction(Main)
        ...
        QtCore.QObject.connect(self.actionQuitter, QtCore.SIGNAL(_fromUtf8("triggered()")), Main.close)
        QtCore.QMetaObject.connectSlotsByName(Main)

    def retranslateUi(self, Main):
        Main.setWindowTitle(_translate("Main", "CryptAlgos", None))
        self.label.setText(_translate("Main", "N", None))
        self.txt_mr_n.setText(_translate("Main", "0", None))
        self.label_2.setText(_translate("Main", "K", None))
        self.txt_mr_k.setText(_translate("Main", "10", None))
        self.label_3.setText(_translate("Main", "Result", None))
        self.btn_mr_run.setText(_translate("Main", "Run", None))
        self.btn_mr_step.setText(_translate("Main", "Step", None))
        self.btn_mr_reset.setText(_translate("Main", "Reset", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Main", "Miller Rabin", None))
        self.label_4.setText(_translate("Main", "N", None))
        self.txt_pm_n.setText(_translate("Main", "1", None))
        self.label_5.setText(_translate("Main", "B", None))
        self.txt_pm_b.setText(_translate("Main", "0", None))
        self.label_6.setText(_translate("Main", "It", None))
        self.txt_pm_it.setText(_translate("Main", "10", None))
        self.label_9.setText(_translate("Main", "Result", None))
        self.btn_pm_run.setText(_translate("Main", "Run", None))
        self.btn_pm_step.setText(_translate("Main", "Step", None))
        self.btn_pm_reset.setText(_translate("Main", "Reset", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Main", "Pm1 Pollard", None))
        self.label_7.setText(_translate("Main", "Size", None))
        self.txt_pg_size.setText(_translate("Main", "1", None))
        self.label_8.setText(_translate("Main", "Result", None))
        self.btn_pg_run.setText(_translate("Main", "Run", None))
        self.btn_pg_step.setText(_translate("Main", "Step", None))
        self.btn_pg_reset.setText(_translate("Main", "Reset", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Main", "Prime Gen", None))
        self.menuFichier.setTitle(_translate("Main", "File", None))
        self.menu.setTitle(_translate("Main", "Help", None))
        self.actionQuitter.setText(_translate("Main", "Exit", None))
        self.actionA_propos.setText(_translate("Main", "About", None))
